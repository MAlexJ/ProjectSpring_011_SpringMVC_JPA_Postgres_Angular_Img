...
public class ArticleServiceImplWithoutImageTest extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    public void testCreateBlockInToArticle() {
        ...
        ArticleEntity expectArticle = articleService.update(entity); // 4. -> Update Article
